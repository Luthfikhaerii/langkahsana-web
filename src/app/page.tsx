  ...
  return (
    <main>
      ...
      <div className="flex md:flex-nowrap sm:flex-nowrap flex-wrap items-start w-full">
        ...
        <Image src={"/images/about_home.webp"} width={0} height={0} alt="foto" className=" polygon-xs md:hidden sm:hidden inline-block"/>
        </div>
        <div className="w-[150%] h-full">
          <div className=" md:p-10 sm:p-14 p-8 bg-coklat-muda md:h-[230px] sm:h-[230px] h-full">
