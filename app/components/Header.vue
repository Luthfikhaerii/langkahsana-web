...
<template>
  <nav class="fixed top-0 w-full z-50 p-4">
    <div
      :class="[
        'max-w-7xl mx-auto flex items-center justify-between md:px-8 px-4 py-3 rounded-xl transition duration-200',
    ...
    >
      ...
      <!-- Desktop menu -->
      <ul class="hidden md:flex md:space-x-10 text-white text-md font-normal mr-4">
