<script setup>
  ...
  const formatPrice = (price) => {
    // Remove 'Rp ' and format the number
    const numericPrice = price.replace(/[^0-9]/g, '')
    return new Intl.NumberFormat('id-ID').format(numericPrice)
  }
  
  onMounted(() => {
    trip.value = trips[id - 1] // Array index starts at 0
  })
  </script>
  
  <template>
    <div v-if="trip" class="min-h-screen bg-gray-50">
      <!-- Hero Image -->
              ...
              <div class="bg-white rounded-lg p-6 shadow-sm">
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p class="text-xl font-bold text-gray-900">{{ trip.kuota }}</p>
                  </div>
                </div>
              </div>
              ...
              <div class="p-6 space-y-8">
                ...
                <div>
                  ...
                  <div class="prose max-w-none">
                    ...
                    <div v-for="(content, index) in trip.content" :key="index" class="mt-4">
                      <img v-if="content.type === 'IMAGE'" :src="content.value" alt="Trip content" class="w-full h-auto rounded-lg" />
                      <p v-if="content.type === 'TEXT'" class="text-gray-700 leading-relaxed">{{ content.value }}</p>
                    </div>
                  </div>
                </div>
                ...
                <!-- Include Section -->
                <div>
                  <h3 class="text-xl font-bold text-gray-900 mb-4">Termasuk</h3>
                  <div class="space-y-2">
                    <div v-for="(item, index) in trip.include" :key="index" class="flex items-start gap-3">
                ...
                <!-- Exclude Section -->
                <div>
                  <h3 class="text-xl font-bold text-gray-900 mb-4">Tidak Termasuk</h3>
                  <div class="space-y-2">
                    <div v-for="(item, index) in trip.exclude" :key="index" class="flex items-start gap-3">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 sticky top-4">
              ...
              <div class="space-y-4 mb-6">
                <div class="flex justify-between items-center py-3 border-b border-gray-100">
                  ...
                  <span class="font-semibold text-gray-900">{{ trip.date }}</span>
                </div>
                <div class="flex justify-between items-center py-3 border-b border-gray-100">
                  <span class="text-gray-600">Durasi</span>
                  <span class="font-semibold text-gray-900">{{ trip.duration }}</span>
                </div>
                <div class="flex justify-between items-center py-3 border-b border-gray-100">
                  <span class="text-gray-600">Sisa Kuota</span>
                  <span class="font-semibold text-green-600">{{ trip.kuota }}</span>
                </div>
              </div>
