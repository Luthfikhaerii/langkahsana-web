          ...
          <div class="relative max-w-7xl mx-auto px-6">
            ...
            <div class="grid md:grid-cols-4 gap-6">
              ...
              <div class="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-6 hover:bg-white/15 hover:border-amber-400 transition-all duration-300 group">
                ...
                <h3 class="text-lg font-bold text-white mb-2">Eksplorasi Berkelanjutan</h3>
                <p class="text-emerald-100 text-sm leading-relaxed">Kami percaya setiap pendakian adalah kesempatan untuk belajar tentang geografi, ekologi, dan sejarah lokal.</p>
              </div>
              ...
              <div class="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-6 hover:bg-white/15 hover:border-amber-400 transition-all duration-300 group">
                ...
                <h3 class="text-lg font-bold text-white mb-2">Komunitas Solid</h3>
                <p class="text-emerald-100 text-sm leading-relaxed">Membangun persaudaraan antar pendaki dengan latar belakang beragam dalam semangat petualangan.</p>
              </div>
              ...
              <div class="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-6 hover:bg-white/15 hover:border-amber-400 transition-all duration-300 group">
                ...
                <h3 class="text-lg font-bold text-white mb-2">Edukasi & Konservasi</h3>
                <p class="text-emerald-100 text-sm leading-relaxed">Setiap trip adalah pembelajaran. Kami berbagi pengetahuan geografi dan menjaga kelestarian alam.</p>
              </div>
              ...
              <div class="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-6 hover:bg-white/15 hover:border-amber-400 transition-all duration-300 group">
                ...
                <h3 class="text-lg font-bold text-white mb-2">Keamanan Utama</h3>
                <p class="text-emerald-100 text-sm leading-relaxed">Keselamatan pendaki adalah prioritas. Semua trip dipandu oleh guide berpengalaman dan terlatih.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <div class="max-w-7xl mx-auto px-6 md:px-8 lg:px-8">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="space-y-6" data-aos="fade-right">
              ...
              <!-- CTA Button -->
              <div class="pt-4">
                <button class="bg-gray-900 text-white px-8 py-4 rounded-md font-medium hover:bg-gray-800 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                  Start Your Journey
                </button>
              </div>
            </div>
            ...
            <div class="relative" data-aos="fade-left">
              ...
              <div class="grid grid-cols-2 gap-4">
                <!-- Gambar Besar -->
                <div class="col-span-2 relative overflow-hidden rounded-md shadow-xl" data-aos="zoom-in">
                  <img
                ...
                <!-- Gambar Kecil 1 -->
                <div class="relative overflow-hidden rounded-md shadow-lg" data-aos="zoom-in" data-aos-delay="150">
                  <img
                ...
                <!-- Gambar Kecil 2 -->
                <div class="relative overflow-hidden rounded-md shadow-lg" data-aos="zoom-in" data-aos-delay="300">
                  <img
